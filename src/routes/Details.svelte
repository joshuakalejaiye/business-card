<script lang="ts">
	import TypedRole from './TypedRole.svelte';
</script>
...
>
	<h1 id="name" class="font-milligram text-5xl lg:text-6xl">Adedayo Kalejaiye (Joshua)</h1>
	<h2
		id="role-container"
	...
	>
		<a
			href="http://github.com/joshuakalejaiye"
			class="hover:text-[#3D2800]"
			target="_blank"
			rel="noopener noreferrer"
			id="gh">GitHub</a
		>
		<a
			href="http://linkedin.com/in/joshuakalejaiye"
			class="hover:text-[#3D2800]"
			rel="noopener noreferrer"
			id="linkedin">LinkedIn</a
		>
		<a
			href="https://fighter-stats.vercel.app"
			class="hover:text-[#3D2800]"
			rel="noopener noreferrer"
			id="fighter-stats">Fighter Stats</a
		>
	</nav>
</div>
